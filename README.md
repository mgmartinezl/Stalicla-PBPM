...
This project contains a module called [PBPM.py](https://github.com/mgmartinezl/PBPM/blob/master/PBPM.py), which contains
a set of functions integrated and called by the [main-PBPM.py](https://github.com/mgmartinezl/PBPM/blob/master/main-PBPM.py) 
script. 
...
patient mutations.
    - Example: ```$ python main-PBPM.py /home/Docs/mutations-file.txt```
...
contains the pathway files with gene annotations.
    - Example: ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/```
...
all available pathways will be extracted by default.
    ...
    ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -pathway R-HSA-69620 ```
    - Example 2: it will run for all possible pathways \
    ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ ```    
...
all available genes will be extracted by default.
    ...
    ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -gene CTR9 ```
...
all available patients will be extracted by default.
    ...
    ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -patient Patient_1 ```
...
all available consequences will be processed by default.
    ...
    ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -mutation missense_variant```
...
* **-pli_gt:** optional argument to filter records with values greater than or equal to a specified pLI threshold.
    - Example: ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -pli_gt 0.6 ```
   
* **-af_lt:** optional argument to filter records with values less than a max_control_AF threshold.
    - Example: ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -af_lt 0.3 ```
...
quotes as they hold blank spaces.
    - Example:  ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -pph2 "possibly damaging" ```
...
* **-mpc_gt:** optional argument to filter records with values greater than or equal to a specified MPC threshold.
    - Example: ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -mpc_gt 0.7 ```
...
parameter include: *PTV*, *Missense3*, *Missense*, etc. 
    - Example:  ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -adj PTV ```
...
Available options are: *binary(b)*, *numerical(n)*, *normalized(nn)*. If not set, the default value of this argument will return a binary matrix.
    - Example to explicitly generate a binary matrix : \
     ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -matrix b ```
    - Example to generate a numerical matrix (not normalized): \
      ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -matrix n ```
    - Example to generate a normalized numerical matrix: \
     ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -matrix nn ```
...
By default, this parameter is set to no (n).
    - Example: ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -r y ```
...
Thus, it will not be necessary to explicitly set the -r parameter to 'yes', unless a separate copy of the base matrix is desired.
    - Example: ```$ python main-PBPM.py /home/Docs/mutations-file.txt /home/pathways/ -append path-to-my-historic-file.txt ```
...
can be found in the folder **InputFiles**. For direct access, click [here.](https://github.com/mgmartinezl/PBPM/tree/master/InputFiles/dummy-mutations-file.txt) 

Similarly, in the **InputFiles** folder, a sample of a directory containing pathways can be found, which is a mandatory
parameter for _pathwaysDirectory_ entry. See it directly [here.](https://github.com/mgmartinezl/PBPM/tree/master/InputFiles/Pathways)

Additional example text files to filter 
[genes](https://github.com/mgmartinezl/PBPM/tree/master/InputFiles/my-file-containing-genes.txt), 
[patients](https://github.com/mgmartinezl/PBPM/tree/master/InputFiles/my-file-containing-patients.txt) and 
[mutations](https://github.com/mgmartinezl/PBPM/tree/master/InputFiles/my-file-containing-mutations.txt) can be found 
in the folder as well.

### Running tests

In the folders [Logs](https://github.com/mgmartinezl/PBPM/tree/master/Logs) and 
[Output](https://github.com/mgmartinezl/PBPM/tree/master/Output), three different running
...
The scripts [PBPM.py](https://github.com/mgmartinezl/PBPM/blob/master/PBPM.py), and 
[main-PBPM.py](https://github.com/mgmartinezl/PBPM/blob/master/main-PBPM.py) 
